...
/**
 *
 * @brief simple example of 3-executor network exchanging public pointers and
 * accessing them locally via unique pointers
 *
 */
...
void r2() {
  ...
  /* access released pointer */
  assert(*p.unique_local().release() == 42);
}
